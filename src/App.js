        ...
        <div className="bodyBox">
          <section className="sideBarBox">
            <Route
              path="/"
              exact
              component={() => <FolderListMain folders={this.state.folders} />}
            />
            <Route
              path="/folder/:folderId"
              component={() => <FolderSideBar folders={this.state.folders} />}
            />
            <Route
              path="/note/:noteId"
              component={(props) => (
          ...
          <section className="noteViewBox">
            ...
            <Route
              path="/folder/:folderId"
              component={(props) => (
                <FolderMain notes={this.state.notes} {...props} />
              )}
            />
            <Route
              path="/note/:noteId"
              component={(props) => (
                <NoteMain notes={this.state.notes} {...props} />
              )}
            />
          </section>
        </div>
